...
#define ERROR_THRESHOLD_OFF  0.20f  /* rad — stop motor when inside this band  */
#define ERROR_THRESHOLD_ON   0.50f  /* rad — restart motor when outside this   */
